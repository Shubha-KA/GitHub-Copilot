...
activities = {
    ...
    "Soccer Team": {
        "description": "Train for matches and improve team strategy in soccer",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Practice shooting, dribbling, and game play in a competitive setting",
    ...
    "Art Workshop": {
        "description": "Create paintings, drawings, and mixed-media projects with guidance",
